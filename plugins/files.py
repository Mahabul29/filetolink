...
# Filter ensures the bot doesn't trigger on its own /start command loop
@Client.on_message(
...
async def file_handler(client, message):
    try:
        ...
        # 4. Create the Inline Buttons (Server style)
        ...
        # 5. Send the professional response with buttons
