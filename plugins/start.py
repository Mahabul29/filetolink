...
from config import BIN_CHANNEL   # Changed to BIN_CHANNEL for consistency
...
async def start_cmd(client: Client, message: Message):
    try:
        ...
        await message.reply_text(
            ...
            "📤 Send or forward any file to me and I will generate a "
            "high-speed direct download link instantly!\n\n"
